//
// $Id: FilterHistoryForm.cs 10324 2017-01-04 22:42:45Z chambm $
//
    ...
    public partial class FilterHistoryForm : DockableForm, IPersistentForm
    {
        ...
        private void SetDefaults()
        {
            _columnSettings = new Dictionary<DataGridViewColumn, ColumnProperty>()
            {
                ...
                { precursorMzToleranceColumn, new ColumnProperty {Type = typeof(string)}},
                ...
                { geneGroupsColumn, new ColumnProperty {Type = typeof(int)}},
                { genesColumn, new ColumnProperty {Type = typeof(int)}},
